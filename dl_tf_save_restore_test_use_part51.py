...
def train_neural_network(x):
    ...
    with tf.Session() as sess:
        ...
        while epoch <= hm_epochs:
            ...
            saver.save(sess, "C:\\Users\\Administrator\\ML-Programs\\model.ckpt")
...
def test_neural_network():
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(hm_epochs):
            try:
                saver.restore(sess,"C:\\Users\\Administrator\\ML-Programs\\model.ckpt")
...
#use_neural_network("Ranjith is a good boy.")
#use_neural_network("Raja is a very bad boy.")
